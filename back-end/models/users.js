...
class User {
   ...
   **/
  static async register({ firstName, lastName, regCode, phone, username, password, email }) {
  ...
  **/
  ...
  /** Return the contact information for all users
   *
   * Returns [ {firstName, lastName, profile_pic, email, phone}, ... ]
  **/
  static async getContacts() {
    ...
    const contactInfo = userRes.rows;
    return contactInfo;
  }
